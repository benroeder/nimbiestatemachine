#!/usr/bin/env python3
"""Add disk to queue and test load_disk trigger."""
...
d = NimbieDriver('1')
if not d.disk_available():
    print("Please add a disk to the input queue and press Enter...")
    input()
...
try:
    ...
    if disk_available:
        ...
        print("❌ FAIL: No disk detected. Please add a disk to the queue.")
