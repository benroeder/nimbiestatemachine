#!/usr/bin/env python3
"""Test error recovery using truly single connection."""
...
def main():
    """Run all error recovery tests with single connection."""
    print("\n" + "="*80)
    print("FIXED SINGLE CONNECTION ERROR RECOVERY TEST")
    print("="*80)
    print("Testing error recovery using ONE connection for all tests")
    ...
    # Summary
    print("\n" + "="*80)
    print("FIXED SINGLE CONNECTION TEST SUMMARY")
    print("="*80)
...
def test_lifted_disk_recovery(sm):
    """Test recovery from lifted disk error state using existing connection."""
...
def test_open_tray_recovery(sm):
    """Test recovery from open tray error state using existing connection."""
...
def test_disk_in_tray_recovery(sm):
    """Test recovery from disk in open tray using existing connection."""
